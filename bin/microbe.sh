#!/bin/bash
# ---------------------------------------------
# Artifact:     microbe/microbe
# Version:      0.2.4
# Date (UTC):   Wed Oct  2 14:21:56 UTC 2013
# Generated by: bashing 0.1.7
# ---------------------------------------------
export __BASHING_VERSION='0.1.7'
export __VERSION='0.2.4'
...
HELP
      ...
      ;;
    "version")
      echo "microbe 0.2.4 (bash $BASH_VERSION)"
      status=0
      ;;
